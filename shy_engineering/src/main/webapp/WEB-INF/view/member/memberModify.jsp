...
<input type="hidden" name="memId" value="${dto.membId }" />
	<table border="1" align="center">
		...
		<tr><td>우편번호</td>
			<td><input type="text" name="postNumber" id="sample4_postcode" value="${dto.postNumber}"/>
			</td></tr>
		<tr><td>주소</td>
		...
		<tr><td>상세주소</td>
			<td><input type="text" name="detailAddr" value="${dto.detailAddr}"/>
			</td></tr>
		<tr><td>연락처</td>
			<td><input type="text" name="membPhoneNumber" value="${dto.membPhoneNumber}" />
			</td></tr>
		<tr><td>생년월일</td>
			<td>
				<fmt:formatDate value="${dto.membBirth}" type="date" pattern="yyyy-MM-dd"/>
				</td></tr>
		<tr><td>성별</td>
			<td>
		...
		<tr><td>이메일</td>
			<td><input type="text" name="membEmail" value="${dto.membEmail}" />
			</td></tr>
		<tr><td>이메일 수신여부</td>
			<td>
